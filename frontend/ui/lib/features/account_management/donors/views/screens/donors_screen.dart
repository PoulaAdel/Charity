...
// binding
part '../../bindings/donors_binding.dart';

// controller
part '../../controllers/donors_controller.dart';

// models

class DonorManagementScreen extends StatelessWidget {
  DonorManagementScreen({Key? key}) : super(key: key);

  final DonorManagementController controller = Get.find();
