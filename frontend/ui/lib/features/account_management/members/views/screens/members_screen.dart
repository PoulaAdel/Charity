...
// binding
part '../../bindings/members_binding.dart';

// controller
part '../../controllers/members_controller.dart';
...
class MemberManagementScreen extends StatelessWidget {
  ...
  final MemberManagementController controller = Get.find();
