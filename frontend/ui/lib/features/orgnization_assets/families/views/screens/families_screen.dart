...
// binding
part '../../bindings/families_binding.dart';

// controller
part '../../controllers/families_controller.dart';

// models

class FamilyManagementScreen extends StatelessWidget {
  FamilyManagementScreen({Key? key}) : super(key: key);

  final FamilyManagementController controller = Get.find();
