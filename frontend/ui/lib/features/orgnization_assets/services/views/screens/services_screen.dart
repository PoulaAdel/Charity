...
// binding
part '../../bindings/services_binding.dart';

// controller
part '../../controllers/services_controller.dart';

// models

class ServiceManagementScreen extends StatelessWidget {
  ServiceManagementScreen({Key? key}) : super(key: key);

  final ServiceManagementController controller = Get.find();
