...
// controller
part '../../controllers/reports_monthly_controller.dart';

class ReportsMonthlyScreen extends StatelessWidget {
  ReportsMonthlyScreen({Key? key}) : super(key: key);

  final ReportsMonthlyController controller = Get.find();
