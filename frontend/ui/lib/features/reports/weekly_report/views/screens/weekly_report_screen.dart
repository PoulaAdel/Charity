...
// binding
part '../../bindings/weekly_report_binding.dart';

// controller
part '../../controllers/weekly_report_controller.dart';

// models

class WeeklyReportScreen extends StatelessWidget {
  WeeklyReportScreen({Key? key}) : super(key: key);

  final WeeklyReportController controller = Get.find();
