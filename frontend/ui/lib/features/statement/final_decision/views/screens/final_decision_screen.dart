...
part '../components/decision_statement_form.dart';

// binding
part '../../bindings/final_decision_binding.dart';

// controller
part '../../controllers/final_decision_controller.dart';
part '../../controllers/decision_statement_form_controller.dart';

// models

class FinalDecisionScreen extends StatelessWidget {
  FinalDecisionScreen({Key? key}) : super(key: key);

  final FinalDecisionController controller = Get.find();
  final DecisionStatementFormController editStatementFormController =
      Get.find();
            ...
            Obx(() {
              ...
              return _buildButtonRow(
                buttons: [
                  _buildSquareButton(
                    'Judgement',
                    Icons.gavel, // Updated icon
                    isEnabled
                        ? () {
                            Get.dialog(
                              DecisionStatementForm(
                                modelType: 'judgement',
                ...
                children: [
                  Expanded(
                    child: _buildSquareButton(
                      'Opinion',
                      Icons.lightbulb, // Updated icon
                      isEnabled
                          ? () async {
                              await controller.fetchOpinion();
                              _showDialog(
                                title: 'Opinion',
                                content: controller.opinion.value?.content ??
                                    'No data avialable',
                              );
                            }
                          : null,
                  ...
                  Expanded(
                    child: _buildSquareButton(
                      'Suggestion',
                      Icons.waving_hand, // Updated icon
                      isEnabled
                          ? () async {
                              await controller.fetchSuggestion();
                              _showDialog(
                                title: 'Suggestion',
                                content: controller.suggestion.value?.content ??
                                    'No data avialable',
                              );
                            }
                          : null,
