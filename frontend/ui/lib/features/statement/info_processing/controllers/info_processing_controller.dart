...
class InfoProcessingController extends GetxController {
  ...
  Rx<Spiritual?> spiritual = Rx<Spiritual?>(null);
  Rx<Economical?> economical = Rx<Economical?>(null);
  Rx<Social?> social = Rx<Social?>(null);
  Rx<Residential?> residential = Rx<Residential?>(null);
  ...
  Future<Statement?> chooseStatement(Family family) async {
  ...
  Future<void> fetchSpiritual() async {
    if (selectedStatement.value != null) {
      try {
        isLoading.value = true;
        var response = await _api.get('spirituals', queryParameters: {
        ...
        Get.snackbar('Error', 'Failed to fetch spiritual data: $e',
            snackPosition: SnackPosition.BOTTOM);
      } finally {
        isLoading.value = false;
      }
  ...
  Future<void> fetchEconomical() async {
    if (selectedStatement.value != null) {
      try {
        isLoading.value = true;
        var response = await _api.get('economicals', queryParameters: {
          'statement': selectedStatement.value!.pk.toString(),
        });
        if (response.isNotEmpty) {
        ...
        Get.snackbar('Error', 'Failed to fetch economical data: $e',
            snackPosition: SnackPosition.BOTTOM);
      } finally {
        isLoading.value = false;
      }
  ...
  Future<void> fetchSocial() async {
    if (selectedStatement.value != null) {
      try {
        isLoading.value = true;
        var response = await _api.get('socials', queryParameters: {
          'statement': selectedStatement.value!.pk.toString(),
        });
        if (response.isNotEmpty) {
        ...
        Get.snackbar('Error', 'Failed to fetch social data: $e',
            snackPosition: SnackPosition.BOTTOM);
      } finally {
        isLoading.value = false;
      }
  ...
  Future<void> fetchResidential() async {
    if (selectedStatement.value != null) {
      try {
        isLoading.value = true;
        var response = await _api.get('residentials', queryParameters: {
          'statement': selectedStatement.value!.pk.toString(),
        });
        if (response.isNotEmpty) {
        ...
        Get.snackbar('Error', 'Failed to fetch residential data: $e',
            snackPosition: SnackPosition.BOTTOM);
      } finally {
        isLoading.value = false;
      }
