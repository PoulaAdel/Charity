...
class ImageAnimationPath {
  ...
  // Example:
  // static const _folderPath = "static/images/animation";
  // static const myAnim = "$_folderPath/my_anim.json";
}

class ImageRasterPath {
  static const _folderPath = "static/images/raster";
  ...
  static const ring = "$_folderPath/ring.jpg";
}

class ImageVectorPath {
  static const _folderPath = "static/images/vector";
...
class DBPath {
  static const dbPath = "static/data.mdb";
}
